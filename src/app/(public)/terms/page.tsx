    ...
    <>
      ...
      <Section>
        <Container className="mx-auto max-w-3xl space-y-4 text-ink-700">
          ...
          <h2 className="text-xl font-semibold text-brand-800">Accounts</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold text-brand-800">Engagement points</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold text-brand-800">Fair use</h2>
          <p>
